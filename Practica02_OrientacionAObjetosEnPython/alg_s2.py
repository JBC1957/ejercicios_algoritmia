...
def generador_recurrencia(coeficientes, funcion_adicional, iniciales):
    ...
    coeficientes = coeficientes(iniciales)
    lista_recurrencia = coeficientes[::1]
    ...
    while True:
        ...
        # valor = sum(coeficientes[i] * lista_recurrencia[i] for i in range(len(coeficientes))) + valor_adicional
        yield valor
